...
class RedirectResolverTest extends TestCase
{
    ...
    public function test_head_requests_are_also_redirected(): void
    {
        Redirect::create(['old_url' => '/gone-page', 'new_url' => '/here-now']);

        $this->head('/gone-page')->assertStatus(301)->assertRedirect('/here-now');
    }
