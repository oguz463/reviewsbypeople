<x-app-layout>
<x-slot name="head">
  <title>{{config('app.name') . ' - ' . __('Reviews')}}</title>
  <meta name="description" content="{{config('app.name') . ' - ' . __('Reviews')}}">
</x-slot>
<div class="max-w-4xl px-6 mx-auto my-8">
  <h1 class="text-4xl font-bold mb-8 uppercase text-center">{{__('Reviews')}}</h1>
