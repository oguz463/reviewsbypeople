...
<x-slot name="head">
    ...
    <meta property="og:title" content="{{asset("storage/uploads/1218-609/{$post->img}")}}" />
    ...
    <meta property="og:image" content="{{asset("storage/uploads/1218-609/{$post->img}")}}" />
    <meta property="og:image:secure_url" content="{{asset("storage/uploads/1218-609/{$post->img}")}}" />
    <meta property="og:image:width" content="1218" />
    <meta property="og:image:height" content="609" />
    <meta name="twitter:card" content="summary" />
    <meta name="twitter:description" content="{{$post->summary}}" />
    <meta name="twitter:title" content="{{$post->seo_title}}" />
    <meta name="twitter:image" content="{{asset("storage/uploads/1218-609/{$post->img}")}}" />
    ...
    <article class="bg-white shadow rounded">
      <div class="rounded overflow-hidden">
        ...
        <section id="updated" class="lg:text-right border-t border-gray-300 mb-8">
          <p><strong>{{__('Last Updated')}}:</strong> {{$post->updated_at->isoFormat('Do MMM, YYYY')}}</p>
        </section>
        ...
        <section id="related">
          <aside class="flex flex-col">
            ...
            <h1 class="text-2xl font-bold text-center lg:text-left mb-4 uppercase">Related Posts</h1>
