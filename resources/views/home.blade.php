      ...
      <div class="bg-white shadow mt-8">
        <div class="px-4 py-2 sm:p-8">
          ...
          <div class="grid grid-cols-2 gap-4 justify-items-center">
            <a href="#" class="py-2 bg-blue-600" aria-label="Facebook">
              <svg class="w-full h-7 text-white fill-current" viewBox="0 0 20 20">
							  <path d="M11.344,5.71c0-0.73,0.074-1.122,1.199-1.122h1.502V1.871h-2.404c-2.886,0-3.903,1.36-3.903,3.646v1.765h-1.8V10h1.8v8.128h3.601V10h2.403l0.32-2.718h-2.724L11.344,5.71z"></path>
						  </svg>
            </a>
            <a href="#" class="py-2 bg-red-600" aria-label="Pinterest">
              <svg class="w-full h-7 text-white fill-current" viewBox="0 0 20 20">
            ...
            <a href="#" class="py-2 bg-indigo-400" aria-label="Twitter">
              <svg class="w-full h-7 text-white fill-current" viewBox="0 0 20 20">
            ...
            <a href="#" class="py-2 bg-pink-600" aria-label="Instagram">
              <svg class="w-full h-7 text-white fill-current" viewBox="0 0 20 20">
