      ...
      <div class="col-lg-8 offset-lg-2 blog__content mb-72">
        ...
        <section class="section">
          <div class="title-wrap">
            <h3 class="section-title">Post a Product</h3>
          </div>
        ...
        <div class="row">
          <div class="col-lg-12 blog__content">
            ...
            <div class="post-area col-xs-12 col-sm-12">
              ...
              @endforeach
              <form action="{{route('product.store')}}" method="POST" class="pt-24" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group mb-0">
                  <input name="url" type="text" placeholder="Affiliate URL" value="{{old('url')}}">
                </div>
