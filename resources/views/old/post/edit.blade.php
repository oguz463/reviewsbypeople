      ...
      <div class="col-lg-8 offset-lg-2 blog__content mb-72">
        ...
        <section class="section">
          <div class="title-wrap">
            <h3 class="section-title">Edit an Article</h3>
          </div>
        ...
        <div class="row">
          <div class="col-lg-12 blog__content">
            ...
            <div class="post-area col-xs-12 col-sm-12">
              ...
              @endforeach
              <form action="{{route('post.update', $post->slug)}}" method="POST" class="pt-24" enctype="multipart/form-data">
                @csrf
                {{method_field('put')}}
                ...
                <div class="form-group">
                  <label>Summary</label>
                  <input name="summary" type="text" value="{{ old('summary') ?? $post->summary }}" maxlength="255">
                </div>

                <div class="form-group">
                  <div id="summernote">{!!old('body')??$post->body!!}</div>
                  <textarea name="body" style="display:none"></textarea>
                </div>

                <div class="form-group mt-24 mb-0">
                  <label>Slug</label>
                  <input name="slug" type="text" value="{{ old('slug') ?? $post->slug }}">
                </div>

                <div class="form-group mb-0">
                  <label>Seo Title</label>
                  <input name="seo_title" type="text" value="{{ old('seo_title') ?? $post->seo_title }}">
                </div>
