...
@section('pageTitle', 'Reviews By People - ' . $category->name)
@section('meta')
<!-- <meta name="robots" content="noindex"> -->
<meta name="description" content="{{$category->name}} reviews - ReviewsByPeople.com">
@endsection
@section('content')
          ...
          <div class="col-lg-8 offset-lg-2 blog__content mb-72">
            ...
            <section class="section">
              <div class="title-wrap text-center">
                <h3 class="section-title" style="float: unset;">{{$category->name}} Reviews</h3>
              </div>

              @forelse ($reviews as $review)
                <article class="entry card post-list">
                  <div class="entry__img-holder post-list__img-holder card__img-holder" style="background-image: url('/storage/uploads/400-240/{{ $review->img }}')">
