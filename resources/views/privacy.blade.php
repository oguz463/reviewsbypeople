...
<x-slot name="head">
  ...
  <meta name="description" content="{{config('app.name') . ' - ' . __('Privacy Policy')}}">
  <style>
    .content-cookies > p {
      margin-bottom: 1rem;
    }
...
<div class="max-w-4xl px-6 mx-auto my-8">
  <aside class="text-lg">
      <h1 class="text-4xl font-bold mb-8 text-center">{{__('Privacy Policy')}}</h1>
      <div class="bg-white rounded shadow overflow-hidden">
        <div class="px-6 py-6 sm:px-12 sm:py-8 content-cookies">
          <h2>INTRODUCTION</h2>
          <p><strong>Last updated</strong> [April 20, 2020]</p>
          <p>Thank you for choosing to be part of our community at Reviews By People (“company”, “we”, “us”, or “our”). We are committed to protecting your personal information and your right to privacy. If you have any questions or concerns about our policy, or our practices with regards to your personal information, please contact us at contact@reviewsbypeople.com</p>
          ...
          <p>This privacy policy applies to all information collected through our websites (such as <a href="https://www.reviewsbypeople.com/">https://www.reviewsbypeople.com/</a>), and/or any related services, sales, marketing or events (we refer to them collectively in this privacy policy as the "<strong>Sites</strong>").</p>
          ...
          <p><strong><em>In Short:</em></strong><em>We collect personal information that you provide to us such as name, contact information, passwords.</em></p>
          <p>We collect personal information that you voluntarily provide to us when [registering at the Sites] expressing an interest in obtaining information about us or our products and services, when participating in activities on the Sites [(such as posting comments in our posts or entering competitions, contests or giveaways)] or otherwise contacting us.</p>
          ...
          <p><strong>Name and Contact Data.</strong> We collect your first and last name, email address, postal address, and other similar contact data.</p>
          ...
          <p>Like many businesses, we also collect information through cookies and similar technologies. [You can find out more about this in our <a href="https://www.reviewsbypeople.com/cookies-policy">Cookies Policy</a>].</p>
          ...
          <ul>
            <li><strong><em>Compliance with Laws</em></strong><em>. We may disclose your information where we are legally required to do so in order to comply with applicable law, governmental requests, a judicial proceeding, court order, or legal process, such as in response to a court order or a subpoena (including in response to public authorities to meet national security or law enforcement requirements).</em></li>
            ...
            <li><strong><em>Third-Party Advertisers</em></strong><em>. We may use third-party advertising companies to serve ads when you visit the Sites. These companies may use information about your visits to our Website(s) and other websites that are contained in web cookies and other tracking technologies in order to provide advertisements about goods and services of interest to you. [See our <a href="https://www.reviewsbypeople.com/cookies-policy/">Cookie Policy</a> for further information] </em></li>

            <li><strong><em>Affiliates. </em></strong><em>We may share your information with our affiliates, in which case we will require those affiliates to honor this privacy policy. Affiliates include our parent company and any subsidiaries, joint venture partners or other companies that we control or that are under common control with us.</em></li>

            <li><strong><em>Business Partners. </em></strong><em>We may share your information with our business partners to offer you certain products, services or promotions. </em></li>

            <li><strong><em>With your Consent. </em></strong><em>We may disclose your personal information for any other purpose with your consent.</em></li>

            <li><strong><em>Other Users. </em></strong><em>When you share personal information (for example, by posting comments, contributions or other content to the Sites) or otherwise interact with public areas of the Site [or App], such personal information may be viewed by all users and may be publicly distributed outside the Site [and our App] in perpetuity. [If you interact with other users of our Sites and register through a social network (such as Facebook), your contacts on the social network will see your name, profile photo, and descriptions of your activity.] Similarly, other users will be able to view descriptions of your activity, communicate with you within our Sites, and view your profile.</em></li>
          </ul>
          ...
          <p>We may use cookies and similar tracking technologies (like web beacons and pixels) to access or store information. Specific information about how we use such technologies and how you can refuse certain cookies is set out in our <a href="https://www.reviewsbypeople.com/cookies-policy">Cookie Policy</a>.</p>
          ...
          <p>Our servers are located in USA. If you are accessing our Sites from outside USA, please be aware that your information may be transferred to, stored, and processed by us in our facilities and by those third parties with whom we may share your personal information (see "Disclosure of Your Information" above), USA, UK and other countries.</p>
          ...
          <p>If you have questions or comments about this policy, email us at <a href="mailto:contact@reviewsbypeople.com">contact@reviewsbypeople.com</a></p>
        </div>
      </div>
  </aside>
</div>
